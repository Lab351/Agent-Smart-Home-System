...
3. 返回 mqtt_broker / mqtt_ws_port / agent_id / capabilities
4. Personal Agent 连接到 MQTT → 192.168.1.100:1883
```
...
| 指标 | 目标 | 测量方法 |
|------|------|---------|
| Beacon Registry 发现延迟 | < 200ms | 查询到响应 |
